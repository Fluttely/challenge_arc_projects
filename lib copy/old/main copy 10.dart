...
class _MyHomePageState extends State<MyHomePage> with TickerProviderStateMixin {
  ...
  @override
  Widget build(BuildContext context) {
    var total = (isActive1 ? 6 : 4) + (isActive2 ? 6 : 4);
    ...
    //             : 4)) /
    //     total;
    // var width1 = (width * (home ? 18 : (isActive1 ? 6 : 4))) / total;
          ...
          children: [
            InkWell(
              ...
              child: AnimatedContainer(
                ...
                width: width1,
                duration: _duration,
                color: isActive1 ? Color(0xFFFC7A09) : Color(0xFF101820),
                child: Column(
                    ...
                    Flexible(
                      child: Text(
                        ...
                        style: TextStyle(
                          // fontFamily: ,
                          color:
                              isActive1 ? Color(0xFF101820) : Color(0xFFFC7A09),
                        ),
                      ),
                    ),
                  ],
            ...
            InkWell(
              ...
              child: AnimatedContainer(
                width: width2,
                duration: _duration,
                color: isActive2 ? Color(0xFFFC7A09) : Color(0xFF101820),
              ),
            ),
            // InkWell(
            //   onTap: () {},
            ...
            //     width: width3,
            //     duration: _duration,
            //     color: isActive3 ? Color(0xFFFC7A09) : Color(0xFF101820),
            //   ),
            // ),
            // InkWell(
            //   onTap: () {},
            ...
            //     width: width4,
            //     duration: _duration,
            //     color: isActive4 ? Color(0xFFFC7A09) : Color(0xFF101820),
            //   ),
            // ),
          ],
        ),
