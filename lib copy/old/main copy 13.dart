...
//   // Animation _animation;
  ...
  //   super.initState();
  //   rxObserver(() {
  //     print(projetcsPageController.home);
  //   });
  //   //   _controller =
  ...
  @override
  Widget build(BuildContext context) {
    var total = (projetcsPageController.isHovered1 ? 6 : 3) +
        (projetcsPageController.isHovered1 ? 3 : 6);
    var width = MediaQuery.of(context).size.width;
    var width1 = (width *
            (projetcsPageController.home
                ? 9
                : projetcsPageController.isHovered1
                    ? 3
                    : 0)) /
        total;
    var width2 = (width *
    ...
    List<Widget> images1 = [
      ...
      RxBuilder(
        builder: (BuildContext context) {
          return Stack(
            children: [
              projetcsPageController.isHovered1 || projetcsPageController.home
                  ? Image.asset(
                      'assets/images/1.jpg',
                      width: MediaQuery.of(context).size.width,
                      height: MediaQuery.of(context).size.height,
                  ...
                  : projetcsPageController.isHovered2
                      ? Image.asset(
                          'assets/images/1.jpg',
                          width: MediaQuery.of(context).size.width,
                          height: MediaQuery.of(context).size.height,
                ...
                child: Row(
                  children: [
                    AnimatedContainer(
                      ...
                      width: width1,
                      duration: _duration,
                      color: projetcsPageController.isHovered1 ||
                              projetcsPageController.home
                          ? Colors.transparent
                          : Colors.white,
                      child: Column(
                    ...
                    InkWell(
                      onTap: () {
                        projetcsPageController
                            .homeState; //value = !projetcsPageController.home;
                      },
                      onHover: (value) {
            ...
            return Stack(
              children: [
                Swiper(
                  ...
                  onIndexChanged: (_) {
                    projetcsPageController.home = false;
                  },
                  loop: false,
